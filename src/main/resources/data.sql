MERGE INTO users (id, username, first_name, last_name) VALUES
    ('9d2df4a9-0085-4838-b8af-d8b46659cb62', 'ivanov', 'Иван', 'Иванов'),
    ('e809075f-1752-411a-8e0c-de3bae23e1b9', 'petrov', 'Петр', 'Петров');

MERGE INTO products (id, type) VALUES
...
MERGE INTO transactions (id, product_id, user_id, type, amount) VALUES
