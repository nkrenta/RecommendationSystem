...
public class RuleStatsController {
    ...
    public ResponseEntity<Map<String, List<Map<String, Object>>>> getStats() {
        ...
        // 2. Строим быстрый индекс (HashMap) для поиска статистики по ID правила
        ...
        // 3. Формируем итоговый список, объединяя правила и статистику
        List<Map<String, Object>> statsList = new ArrayList<>();
        for (DynamicRule rule : allRules) {
            Map<String, Object> entry = new LinkedHashMap<>();
            entry.put("rule_id", rule.getId().toString());

            // Получаем статистику или дефолтное значение 0
